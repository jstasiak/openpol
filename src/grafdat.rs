...
mod tests {
    ...
    fn test_loading_and_saving_images_works() {
        ...
        let loaded_images = Grafdat::load_images(&dummy_graf_dat_content[..]).unwrap();
        ...
        assert_eq!(loaded_images, expected_images);
        // ...then make sure that after saving grafdat images we get the exact save binary content.
        let mut buf = Vec::new();
        Grafdat::save_images(&loaded_images, &mut buf);
